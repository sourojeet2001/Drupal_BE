...
/**
 * @var object Drupal\Core\Database\Connection
 */
  protected $conn;

  /**
   * @var object Drupal\Core\Config\ConfigFactoryInterface
   */
  protected $config;
  ...
  public function build() {
    $result = $this->config->get('FlagshipBlockForm.settings')->get('data');
    return [
      '#theme' => 'block-form',
      '#data' => $result,
      '#attached' => [
